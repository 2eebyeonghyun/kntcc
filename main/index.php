			...
			<div class="inner">
				<div class="noticebox_">
					<div class="main_box">
						...
						<div class="txt">
							<a href="<?=lbh?>/community/sub1.php">
								<h3 class="head">경남금연지원센터 테스트 공지사항</h3>
								<p class="sub">경남금연지원센터 공지사항 글입니다.</p>
				...
				<div class="reviewbox_">
					<div class="main_box">
						...
						<div class="txt">
							<a href="<?=lbh?>/community/sub2.php">
								<h3 class="head">경남금연지원센터 금연캠프 후기 게시글</h3>
								<p class="sub">경남금연지원센터 금연캠프 글입니다.</p>
								<p class="date">2022.10.07</p>
							</a>
						</div>
					</div>
