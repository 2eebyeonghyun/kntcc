    ...
    <div id="svis" style="background:url(../img/request/svis.png)no-repeat center/cover;">
        <div class="inner">
            ...
            <ul class="snb">
                ...
                <li class="active"><a href="../request/sub3.php">금연캠프 신청</a></li>
    ...
    <div class="container" id="container">
        <div class="inner">
            <div class="page_title">
                <strong>금연캠프 신청</strong>
                <p>Application</p>
            </div>

            <form action="" method="post" name="vstfrm" id="vstfrm" onsubmit="return subibtn();">
                <p class="it_">4박 5일<br><strong><span style="color:#c75d6d;">금연캠프 신청</span></strong></p>
                    ...
                    <ul class="agree-list">
                        <li>
                            ...
                            <div id="agree-cont1" class="agree-cont agree-cont1" style="display: none;">
                                ...
                                <ul class="list-style">
                                    <li>- 수집항목 : 이름, 성별, 생년월일, 주소, 연락처, 하루 평균 흡연량(선택), 총 흡연기간</li>
                ...
                <table class="__tbl-write">
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">신청 유형</td>
                            <td>
                                <select name="m_type" id="m_type">
                                    <option value="4박 5일 금연캠프">4박 5일 금연캠프</option>
                                    <option value="입원환자">입원환자</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="locationbox">
                                    <input type="text" class="__form1 applicant_loca bbx_off" name="m_zip" onfocus="clOn2(this)" onblur="if(this.value != '') this.className='bbx_w'; else clOff2(this)" id="cube_postcode">
                        ...
                        <tr>
                        	...
                        	<td>
                        		<div class="filebox">
                        			<input class="upload-name" name="" value="첨부파일" placeholder="첨부파일" onfocus="clOn2(this)" onblur="if(this.value != '') this.className='bbx_w'; else clOff2(this)">
                        			<label for="file">파일찾기</label>
                        			<input type="file" id="file">
                        			<p style="width: 100%; margin-top: 5px; display: block; color: #d91d4d; font-size:12px;">ex) 감면대상자 중 만 65세 이상시 주민등록증, 기초생활수급자 증명서, 의료급여 수급자증, 장애인증 / 일괄공통 참가비 환급 시 필요한 통장사본</p>
                        		</div>
                        	</td>
                        </tr>
                        <tr>
